...
export default function RscmsCard() {
  ...
  return (
    <div className="relative flex flex-col h-full rounded-2xl overflow-hidden border border-blue-900/40 bg-zinc-950">
      {/* Title bar */}
      <div className="flex items-center gap-2 px-4 py-3 border-b border-blue-900/30 bg-[#0a0d14]/80 shrink-0">
        <span className="w-3 h-3 rounded-full bg-red-500/80" />
        <span className="w-3 h-3 rounded-full bg-yellow-500/80" />
        <span className="w-3 h-3 rounded-full bg-blue-500/80" />
        <span className="ml-2 text-xs text-blue-400/60 font-mono tracking-wide">rscms — compliance-audit.sh</span>
      </div>
      ...
      {/* Footer */}
      <div className="px-4 py-2 border-t border-blue-900/30 bg-[#0a0d14]/60 shrink-0 flex items-center justify-between">
        <span className="text-[10px] font-mono text-blue-400/40 uppercase tracking-widest">RSCMS / ISO·NIST Compliance</span>
